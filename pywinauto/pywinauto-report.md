...
- Извлечение информации из GUI приложения (составление отчетов о работе программы, использования результатов работы программы в качестве входных данных для другой и т.п.).
...
Целью данной работы является разработка инструмента, который:
...
Рассмотрим перечень доступных инструментов для автоматизации GUI приложений, которые использую подход применения Accessibility технологий.

https://github.com/pywinauto/pywinauto/wiki/UI-Automation-tools-ratings
https://pywinauto.github.io/docs/index.html#some-similar-tools-for-comparison
