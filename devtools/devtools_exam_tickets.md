...
* Пространства имен XML сложно использовать и реализовывать в XML парсерах.
...
1. Серилизация структур

Плюсы:

* За счет своей лаконичности по сравнению с XML, формат может быть более подходящим для сериализации сложных структур (чаще всего используется в веб-приложениях)
